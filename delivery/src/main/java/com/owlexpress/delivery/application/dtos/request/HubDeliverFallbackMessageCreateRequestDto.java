...
public class HubDeliverFallbackMessageCreateRequestDto {
    ...
    public static HubDeliverFallbackMessageCreateRequestDto toDto(
            AlarmCreateResponseDto responseDto
    ) {
        return HubDeliverFallbackMessageCreateRequestDto.builder()
                .aiId(responseDto.getAiId())
                .messageId(responseDto.getPlatformMessageId())
                .deliverId(responseDto.getDeliveryId())
                .deliverUserId(responseDto.getDeliverUserId())
                .deliverName(responseDto.getDeliverName())
                .deliverChannelId(responseDto.getDeliverChannelId())
                .platformName(responseDto.getPlatformName())
                .deliveryId(responseDto.getDeliveryId())
                .orderId(responseDto.getOrderId())
                .productInfo(responseDto.getProductInfo())
                .ordererName(responseDto.getOrdererName())
                .shippingAddress(responseDto.getShippingAddress())
                .build();
    }
}
