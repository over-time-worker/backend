...
public class AiController {
    ...
    public ResponseEntity<CommonDto<MessageCreateResponseDto>> createMessagesForHubDeliver(
        ...
        MessageCreateResponseDto responseDto
                = aiService.createMessageForHubDeliver(hubDeliverMessageCreateRequestDto, passport);
    ...
    public ResponseEntity<CommonDto<MessageCreateResponseDto>> createMessagesForCompanyDeliver(
        ...
        MessageCreateResponseDto responseDto
                = aiService.createMessageForCompanyDeliver(companyDeliverMessageCreateRequestDto, passport);
